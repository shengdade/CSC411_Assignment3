...
def save_vgg19(save_path='../../411a3/train_vgg19.npz'):
    X_train, y_train = extract_vgg19()
    train = {
        'X_train': X_train,
        'y_train': y_train
    }
...
def save_vgg19_val(save_path='../../411a3/train_vgg19_val.npz'):
    X_val = extract_vgg19_val()
    val = {
        'X_val': X_val
    }
    Save(save_path, val)
...
def load_vgg19(nb_test=0, load_path='../../411a3/train_vgg19.npz'):
...
def load_vgg19_val(load_path='../../411a3/train_vgg19_val.npz'):
    val = Load(load_path)
    X_val = val['X_val']
...
def main():
    ...
    (X_train, y_train), (X_test, y_test) = load_vgg19()
